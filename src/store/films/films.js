...
import {MAX_SIMILAR_FILMS_AMOUNT} from "../../constants";
...
export const ActionType = {
  ...
  UPDATE_FAVORITE_MOVIE: `UPDATE_FAVORITE_MOVIE`,
...
export const loadFlmsList = (films) => ({
...
export const selectSimilarFilms = createSelector(
    ...
    (films, film)=> getSimilarFilms(films, film).slice(0, MAX_SIMILAR_FILMS_AMOUNT)
);

import {ActionType, filmsReducer, loadFavoriteFilms, loadFilm, loadFlmsList, loadPromoFilm, updateFilmsInfo} from "../films/films";
import {films, film} from "../../mocks/films";

describe(`User action creators returns correct actions`, () => {
  it(`load films`, () => {
    expect(loadFlmsList(films)).toEqual({

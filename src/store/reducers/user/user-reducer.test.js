...
describe(`user reducer sync operations`, () => {
  it(`user reducer returns initial state`, () => {
    expect(user(undefined, {})).toEqual({
      authorizationStatus: AuthorizationStatus.NO_AUTH,
    });
  });

  it(`user reducer changes authorization status`, () => {
    expect(user({
      authorizationStatus: AuthorizationStatus.NO_AUTH,
    }, {
...
describe(`user reducer async operations`, () => {
  it(`makes a correct API call to check auth at: /login`, () => {
  ...
  it(`makes a correct API call to login at: /login`, () => {
    const apiMock = new MockAdapter(api);
    const dispatch = jest.fn();

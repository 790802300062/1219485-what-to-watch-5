...
import {RequestStatus, AuthorizationStatus} from "../../constants";
...
export const isUserRequested = (state) => selectUserRequestStatus(state) === RequestStatus.REQUESTED;
export const isUserRequestFailed = (state) => selectUserRequestStatus(state) === RequestStatus.REQUEST_FAILED;
export const isUserLoggedIn = (state) => selectAuthorizationStatus(state) === AuthorizationStatus.AUTH;

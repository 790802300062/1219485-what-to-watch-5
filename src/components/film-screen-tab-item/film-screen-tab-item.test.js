...
describe(`FilmScreenTabItem render`, () => {
  ...
  it(`renders FilmScreenTabItem component with non-active status and Details type`, () => {
    const tree = renderer
      .create(
          <FilmScreenTabItem
            isActive={false}
  ...
  it(`renders FilmScreenTabItem component with non-active status and Overview type`, () => {
    const tree = renderer
      .create(
          <FilmScreenTabItem
            isActive={false}
